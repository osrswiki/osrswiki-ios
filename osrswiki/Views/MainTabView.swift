...
struct MainTabView: View {
    ...
    var body: some View {
        ...
        // Root tabs are selected by the persistent tab bar. A full-screen horizontal recognizer
        // competed with native carousels and could switch tabs while their contents were scrolled.
        // Article navigation owns its separately scoped WebView recognizer.
    ...
    private var newsTab: some View {
        ...
        NewsView()
            ...
            .accessibilityIdentifier(TabItem.news.accessibilityIdentifier)
    }
    ...
    private var savedTab: some View {
        ...
        SavedPagesView()
            ...
            .accessibilityIdentifier(TabItem.saved.accessibilityIdentifier)
    }
    ...
    private var searchTab: some View {
        ...
        SearchView()
            ...
            .accessibilityIdentifier(TabItem.search.accessibilityIdentifier)
    }
    ...
    private var mapTab: some View {
        ...
        MapView()
            ...
            .accessibilityIdentifier(TabItem.map.accessibilityIdentifier)
    }
    ...
    private var moreTab: some View {
        ...
        MoreView()
            ...
            .accessibilityIdentifier(TabItem.more.accessibilityIdentifier)
    }
}
