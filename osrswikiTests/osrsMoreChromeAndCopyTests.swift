...
final class osrsMoreChromeAndCopyTests: XCTestCase {
    func testEveryPushedMoreDestinationUsesSharedTranslucentChrome() throws {
        ...
        XCTAssertTrue(swipe.contains("hitView(for: touch, in:"))
        XCTAssertTrue(swipe.contains("window.hitTest(point, with: nil)"))
        XCTAssertTrue(swipe.contains("isHorizontalScroller"))
    ...
    func testDonateAndFeedbackCopyAndOutboundRowsMatchTheSharedPolicy() throws {
        ...
        XCTAssertTrue(donate.contains("Support the OSRS Wiki App"))
        XCTAssertTrue(donate.contains("Donation cancelled"))
        XCTAssertTrue(donate.contains("displayPrice(for:"))
        XCTAssertFalse(donate.contains("amount: .custom"))
        XCTAssertFalse(donate.contains("currency picker"))
        XCTAssertFalse(donate.contains("apple-pay-donation"))
        XCTAssertFalse(donate.contains("import PassKit"))
