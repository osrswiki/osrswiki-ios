...
final class IOS08SearchHomeDiagnosticsTests: XCTestCase {
    ...
    func testRootTabsUseOneHeaderAndSearchLauncherContract() throws {
        ...
        XCTAssertTrue(helper.contains("Text(placeholder)"))
        XCTAssertTrue(helper.contains(".accessibilityHidden(true)"))
        XCTAssertTrue(helper.contains("configuration.title = nil"))
